...
e1.grid(row=0, column=1, padx=15, pady=6)
e2.grid(row=1, column=1, padx=15, pady=6)

Button(root, text='下载', width=10, command=download) .grid(row=2, column=0, sticky=W, padx=10, pady=5)
Button(root, text='退出', width=10, command=quit) .grid(row=2, column=1, sticky=E, padx=10, pady=5)
